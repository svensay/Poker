...
type com = QuinteFlush of valeur
	   |Carre of valeur*valeur(*1er valeur -> suite de 4, 2éme valeur -> en cas d'égalité, compare avec cette valeur*)
	   |Full of valeur*valeur(*1er valeur -> suite de 3, 2éme valeur -> en cas d'égalité, compare suite de 2*)
	   |Couleur of valeur*valeur*valeur*valeur*valeur (*en cas d'égalité faut verifier la carte suivante*)
	   |Suite of valeur
	   |Brelan of valeur*valeur*valeur
